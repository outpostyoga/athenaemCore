...
// Logic. Path module for safe resolution and navigation.

const $0M_Path = require ( "path" );

// Data. Directory to serve files from.

const $0M_pathToBaseDirectory = $0M_Path.join ( __dirname );

// Data. Directory to archive files to.

const $0M_pathToLogDirectory = $0M_pathToBaseDirectory + "\\log";

// Data. Directory to write files to.

const $0M_pathToLogDirectoryBinDirectory = $0M_pathToLogDirectory + "\\bin";

// Data. Bin file extension. Female.

const $0M_pathToLogDirectoryBinDirectoryBinExtensionFemale = ".txt";

// Data. Bin file extension. Male.

const $0M_pathToLogDirectoryBinDirectoryBinExtensionMale = "txt";

// Flag. Where to put the log output.

const $0M_writeLogToConsole = true;

// Flag. Where to put the log output.

const $0M_writeLogToFile = true;

// Logic. Export settings.

module.exports = { $0M_htmlErrorCodes, $0M_htmlMimeTypes, $0M_i18n, $0M_pathToBaseDirectory, $0M_pathToLogDirectory, $0M_pathToLogDirectoryBinDirectory, $0M_pathToLogDirectoryBinDirectoryBinExtensionFemale, $0M_writeLogToConsole, $0M_writeLogToFile };